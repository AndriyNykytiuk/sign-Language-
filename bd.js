...
async function getAllLessonsWithObjects() {
  const sql = `
    SELECT l.id as "lessonId", l.name, o.id as "objectId", o.wordName as "wordName", o.videoLink as "videoLink", o.pictLink as "pictLink"
    FROM lessons l
...
async function getObjectsByLessonId(lessonId) {
  const sql = `
    SELECT o.id as "objectId", o.wordName as "wordName", o.videoLink as "videoLink", o.pictLink as "pictLink"
